...
#include "EstrategiaDisparoAdelante.generated.h"

UCLASS()
class PVZ_USFX_LAB02_API AEstrategiaDisparoAdelante : public AActor, public IEstrategiasD
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AEstrategiaDisparoAdelante();
